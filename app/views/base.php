...
<header class="section-header ">
    <div class="section-header__wrapper">
        ...
        <div class="section-header__user">
            <button type="button" class="nav-link active" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                se connecter
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5 input-text" id="staticBackdropLabel">Se connecter</h1>
                            ...
                            <form class="row g-3" action="" method="">
                                <div class="col-md-6">
                                    ...
                                    <input id="email" type="email" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                </div>
                                <div class="col-md-6">
                                    <label for="password" class="form-label input-text">Mot de passe</label>
                                    <input id="password" type="password" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                </div>
                            </form>
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item">
                                    ...
                                    <form class="modal-content__form-wrapper" action="">
                                            ...
                                            <div class="accordion-body">
                                                <fieldset class="modal-body__form-wrapper" action="">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="username" type="text" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    </div>
                                                    <label for="email" class="form-label input-text">E-mail</label>
                                                    <div class="input-group mb-3">
                                                        <input id="email" type="email" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="phone" type="tel" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    </div>
                                                    <label for="password" class="form-label input-text">Mot de passe</label>
                                                    <div class="input-group mb-3">
                                                        <input id="password" type="password" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input id="PasswordConfirmation" type="password" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    </div>
                                                    <label class="form-label input-text">Prénom et nom de famille</label>
                                                    <div class="input-group mb-3">
                                                        <input id="firstname" type="text" aria-label="prenom" class="form-control">
                                                        <input id="lastname" type="text" aria-label="nom de famille" class="form-control">
                                                    </div>
                                                    <label for="date_of_birth" class="form-label input-text">Date de naissance</label>
                                                    <div class="input-group mb-3">
                                                        <input id="date_of_birth" type="date" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                    </div>
                                                    <label for="gender" class="form-label input-text">Genre</label>
                                                    <div class="input-group mb-3">
